...
| ZP | LUT for frequent states (#181) | likely neutral | all 4 ZP tables (PROB/MPS_NEXT/LPS_NEXT/THRESHOLD) total ~1.5 KB; already fit entirely in L1 cache (192 KB on M1); a combined struct would be larger and cause more cache-line evictions per lookup, not fewer; not worth pursuing |
