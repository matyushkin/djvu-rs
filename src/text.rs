...
//! ## Data model
//!
//! Types are defined in [`crate::text_model`].  This module re-exports them so
//! callers that only need the parser can import everything from one place.
//!
//! ## Format notes
//!
