...
| IW44_MASKED_WAVELET | 2026-07-02 | IW44 encoder (size) | **CLOSED** (r20) | superseded by BG_DIFFUSE (r17) | Masked BG encoding (DjVuLibre c44 lever). **Resolved:** the low-risk first step (BG_DIFFUSE, r17) captured the whole win interop-safely; IW44_MASKED_TRANSFORM (r20) then measured the normative transform adds 0 on top (c44 -mask ≈ c44-on-diffused). No further masked work needed; residual gap is entropy coding, not masking. |
